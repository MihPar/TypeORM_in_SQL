...
describe('/blogs', () => {
  ...
  describe('some description', () => {
    ...
    it('create questions and published', async () => {
      const question = await createQuestionsAndPublished(
        server,
        questionsInMemory,
      );
    ...
    it('create pairs first game (1 and 2)', async () => {
      const connectOneAndTwoRes = await toCreatePair(
        server,
        user1Token,
        user2Token,
      );
      ...
      const send1AnswerOnFirstGameByFirstPlayer = await sendAnswersFirstPlayer(
        server,
        user1Token,
        'Incorrect',
        firstGame,
      );
      const found1FirstGameFirstPlayer = await findGameById(
        server,
        firstGame.id,
        user1Token,
      );
      //   console.log(
      //     'found1FirstGameFirstPlayer: ',
      //     found1FirstGameFirstPlayer[1].firstPlayerProgress.score,
      //   );

      const send2AnswerOnFirstGameByFirstPlayer = await sendAnswersFirstPlayer(
        server,
        user1Token,
        'Incorrect',
        firstGame,
      );
      const found2FirstGameFirstPlayer = await findGameById(
        server,
        firstGame.id,
        user1Token,
      );
      //   console.log(
      //     'found2FirstGameFirstPlayer: ',
      //     found2FirstGameFirstPlayer[1].firstPlayerProgress.score,
      //   );

      const send3AnswerOnFirstGameByFirstPlayer = await sendAnswersFirstPlayer(
        server,
        user1Token,
        'Incorrect',
        firstGame,
      );
      const found3FirstGameFirstPlayer = await findGameById(
        server,
        firstGame.id,
        user1Token,
      );
      //   console.log(
      //     'found3FirstGameFirstPlayer: ',
      //     found3FirstGameFirstPlayer[1].firstPlayerProgress.score,
      //   );

      const sendA4nswerOnFirstGameByFirstPlayer = await sendAnswersFirstPlayer(
        server,
        user1Token,
        'Incorrect',
        firstGame,
      );
      const found4FirstGameFirstPlayer = await findGameById(
        server,
        firstGame.id,
        user1Token,
      );
      //   console.log(
      //     'found4FirstGameFirstPlayer: ',
      //     found4FirstGameFirstPlayer[1].firstPlayerProgress.score,
      //   );

      const send5AnswerOnFirstGameByFirstPlayer = await sendAnswersFirstPlayer(
        server,
        user1Token,
        'Incorrect',
        firstGame,
      );
      const found5FirstGameFirstPlayer = await findGameById(
        server,
        firstGame.id,
        user1Token,
      );
      //   console.log(
      //     'found5FirstGameFirstPlayer: ',
      //     found5FirstGameFirstPlayer[1].firstPlayerProgress.score,
      //   );
      ...
      const send1AnswerOnFirstGameBySecondPlayer =
        await sendAnswersSecondPlayer(server, user2Token, 'Correct');
      const found1FirstGameSecond = await findGameById(
        server,
        firstGame.id,
        user2Token,
      );
      //   console.log(
      //     'found1FirstGameSecond: ',
      //     found1FirstGameSecond[1].secondPlayerProgress.score,
      //   );

      const send2AnswerOnFirstGameBySecondPlayer =
        await sendAnswersSecondPlayer(server, user2Token, 'Correct');
      const found2FirstGameSecond = await findGameById(
        server,
        firstGame.id,
        user2Token,
      );
      //   console.log(
      //     'found2FirstGameSecond: ',
      //     found2FirstGameSecond[1].secondPlayerProgress.score,
      //   );

      const send3AnswerOnFirstGameBySecondPlayer =
        await sendAnswersSecondPlayer(server, user2Token, 'Correct');
      const found3FirstGameSecond = await findGameById(
        server,
        firstGame.id,
        user2Token,
      );
      //   console.log(
      //     'found3FirstGameSecond: ',
      //     found3FirstGameSecond[1].secondPlayerProgress.score,
      //   );

      const send4AnswerOnFirstGameBySecondPlayer =
        await sendAnswersSecondPlayer(server, user2Token, 'Correct');
      const found4FirstGameSecond = await findGameById(
        server,
        firstGame.id,
        user2Token,
      );
      //   console.log(
      //     'found4FirstGameSecond: ',
      //     found4FirstGameSecond[1].secondPlayerProgress.score,
      //   );
      //   console.error('--------start---------');
      const send5AnswerOnFirstGameBySecondPlayer =
        await sendAnswersSecondPlayer(server, user2Token, 'Correct');
      const found5FirstGameSecond = await findGameById(
        server,
        firstGame.id,
        user2Token,
      );
      //   console.log(
      //     'found5FirstGameSecond: ',
      //     found5FirstGameSecond[1].secondPlayerProgress.score,
      //   );
    ...
    it('create pairs second game (3 and 4)', async () => {
      const connectThreeAndFourRes = await toCreatePair(
        server,
        user3Token,
        user4Token,
      );
      ...
      const send1AnswerOnSecondGameByThirdPlayer = await sendAnswersFirstPlayer(
        server,
        user3Token,
        'Incorrect',
        secondGame,
      );
      const found1SecondGameThirdPlayer = await findGameById(
        server,
        secondGame.id,
        user3Token,
      );
      ...
      const send2AnswerOnSecondGameByThirdPlayer = await sendAnswersFirstPlayer(
        server,
        user3Token,
        'Incorrect',
        secondGame,
      );
      const found2SecondGameThirdPlayer = await findGameById(
        server,
        secondGame.id,
        user3Token,
      );
      ...
      const send3AnswerOnSecondGameByThirdPlayer = await sendAnswersFirstPlayer(
        server,
        user3Token,
        'Incorrect',
        secondGame,
      );
      const found3SecondGameThirdPlayer = await findGameById(
        server,
        secondGame.id,
        user3Token,
      );
      ...
      const found4SecondGameThirdPlayer = await findGameById(
        server,
        secondGame.id,
        user3Token,
      );
      ...
      const send1AnswerOnSecondGameByFourthPlayer =
        await sendAnswersSecondPlayer(server, user4Token, 'Correct');
      const found1SecondGameFourthPlayer = await findGameById(
        server,
        secondGame.id,
        user4Token,
      );
      ...
      const send2AnswerOnSecondGameByFourthPlayer =
        await sendAnswersSecondPlayer(server, user4Token, 'Correct');
      const found2SecondGameFourthPlayer = await findGameById(
        server,
        secondGame.id,
        user4Token,
      );
      ...
      const send3AnswerOnSecondGameByFourthPlayer =
        await sendAnswersSecondPlayer(server, user4Token, 'Correct');
      const found3SecondGameFourthPlayer = await findGameById(
        server,
        secondGame.id,
        user4Token,
      );
      ...
      const send4AnswerOnSecondGameByFourthPlayer =
        await sendAnswersSecondPlayer(server, user4Token, 'Correct');
      const found4SecondGameFourthPlayer = await findGameById(
        server,
        secondGame.id,
        user4Token,
      );
      ...
      const send5AnswerOnSecondGameByFourthPlayer =
        await sendAnswersSecondPlayer(server, user4Token, 'Correct');
      const found5SecondGameFourthPlayer = await findGameById(
        server,
        secondGame.id,
        user4Token,
      );
      ...
      expect(found1SecondGameFourthPlayer[1].secondPlayerProgress.score).toBe(
        1,
      );
      expect(found2SecondGameFourthPlayer[1].secondPlayerProgress.score).toBe(
        2,
      );
      expect(found3SecondGameFourthPlayer[1].secondPlayerProgress.score).toBe(
        3,
      );
      expect(found4SecondGameFourthPlayer[1].secondPlayerProgress.score).toBe(
        4,
      );
      expect(found5SecondGameFourthPlayer[1].secondPlayerProgress.score).toBe(
        5,
      );

      const send5AnswerOnSecondGameByThirdPlayer = await sendAnswersFirstPlayer(
        server,
        user3Token,
        'Incorrect',
        secondGame,
      );
      const found5SecondGameThirdPlayer = await findGameById(
        server,
        secondGame.id,
        user3Token,
      );
    ...
    it('create pairs third game (2 and 1)', async () => {
      ...
      const send1AnswerOnThirdGameBySecondPlayer =
        await sendAnswersSecondPlayer(server, user2Token, 'Correct');
      const found1ThirdGameSecondPlayer = await findGameById(
        server,
        firdGame.id,
        user2Token,
      );
      ...
      const send2AnswerOnThirdGameBySecondPlayer =
        await sendAnswersSecondPlayer(server, user2Token, 'Correct');
      const found2ThirdGameSecondPlayer = await findGameById(
        server,
        firdGame.id,
        user2Token,
      );
      ...
      const send3AnswerOnThirdGameBySecondPlayer =
        await sendAnswersSecondPlayer(server, user2Token, 'Correct');
      const found3ThirdGameSecondPlayer = await findGameById(
        server,
        firdGame.id,
        user2Token,
      );
      ...
      const send4AnswerOnThirdGameBySecondPlayer =
        await sendAnswersSecondPlayer(server, user2Token, 'Correct');
      const found4ThirdGameSecondPlayer = await findGameById(
        server,
        firdGame.id,
        user2Token,
      );
      ...
      const send5AnswerOnThirdGameBySecondPlayer =
        await sendAnswersSecondPlayer(server, user2Token, 'Correct');
      const found5ThirdGameSecondPlayer = await findGameById(
        server,
        firdGame.id,
        user2Token,
      );
      ...
      const send1AnswerOnThirdGameByFirstPlayer = await sendAnswersFirstPlayer(
        server,
        user1Token,
        'Incorrect',
        firdGame,
      );
      const found1ThirdGameFirstPlayer = await findGameById(
        server,
        firdGame.id,
        user1Token,
      );
      ...
      const send2AnswerOnThirdGameByFirstPlayer = await sendAnswersFirstPlayer(
        server,
        user1Token,
        'Incorrect',
        firdGame,
      );
      const found2ThirdGameFirstPlayer = await findGameById(
        server,
        firdGame.id,
        user1Token,
      );
      ...
      const send3AnswerOnThirdGameByFirstPlayer = await sendAnswersFirstPlayer(
        server,
        user1Token,
        'Incorrect',
        firdGame,
      );
      const found3ThirdGameFirstPlayer = await findGameById(
        server,
        firdGame.id,
        user1Token,
      );
      ...
      const sendA4nswerOnThirdGameByFirstPlayer = await sendAnswersFirstPlayer(
        server,
        user1Token,
        'Incorrect',
        firdGame,
      );
      const found4ThirdGameFirstPlayer = await findGameById(
        server,
        firdGame.id,
        user1Token,
      );
      ...
      const send5AnswerOnThirdGameByFirstPlayer = await sendAnswersFirstPlayer(
        server,
        user1Token,
        'Incorrect',
        firdGame,
      );
      const found5ThirdGameFirstPlayer = await findGameById(
        server,
        firdGame.id,
        user1Token,
      );
      ...
      const resultGameSecondPlayer = await findGameById(
        server,
        firdGame.id,
        user2Token,
      );
      ...
      //   console.log(
      //     'resultGameSecondPlayer: ',
      //     resultGameSecondPlayer[1].secondPlayerProgress.score,
      //   );
    ...
    it('create pair by fourth game (1 and 2)', async () => {
      ...
      const send1AnswerOnFourthGameBySeconPlayer = await sendAnswersFirstPlayer(
        server,
        user2Token,
        'Incorrect',
        fourthGame,
      );
      const found1FourthGameSecondPlayer = await findGameById(
        server,
        fourthGame.id,
        user2Token,
      );
    ...
    //   );
      ...
      const found2FourthGameSecondPlayer = await findGameById(
        server,
        fourthGame.id,
        user2Token,
      );
    ...
    //   );
      ...
      const found3FourthGameSecondPlayer = await findGameById(
        server,
        fourthGame.id,
        user2Token,
      );
    ...
    //   );
      ...
      const found4FourthGameSecondPlayer = await findGameById(
        server,
        fourthGame.id,
        user2Token,
      );
    ...
    //   );
      ...
      const found5FourthGameSecondPlayer = await findGameById(
        server,
        fourthGame.id,
        user2Token,
      );
      //   console.log(
      //     'found5FourthGameSecondPlayer: ',
      //     found5FourthGameSecondPlayer[1].secondPlayerProgress.score,
      //   );

      expect(found1FourthGameSecondPlayer[1].secondPlayerProgress.score).toBe(
        0,
      );
      expect(found2FourthGameSecondPlayer[1].secondPlayerProgress.score).toBe(
        0,
      );
      expect(found3FourthGameSecondPlayer[1].secondPlayerProgress.score).toBe(
        0,
      );
      expect(found4FourthGameSecondPlayer[1].secondPlayerProgress.score).toBe(
        0,
      );
      expect(found5FourthGameSecondPlayer[1].secondPlayerProgress.score).toBe(
        0,
      );

      /* first player */

      const send1AnswerOnFourthGameByFirstPlayer =
        await sendAnswersSecondPlayer(server, user1Token, 'Correct');
      const found1FourthGameFirstPlayer = await findGameById(
        server,
        fourthGame.id,
        user1Token,
      );
    ...
    //   );
      ...
      const send2AnswerOnFourthGameByFirstPlayer =
        await sendAnswersSecondPlayer(server, user1Token, 'Correct');
      const found2FourthGameFirstPlayer = await findGameById(
        server,
        fourthGame.id,
        user1Token,
      );
    ...
    //   );
      ...
      const send3AnswerOnFourthGameByFirstPlayer =
        await sendAnswersSecondPlayer(server, user1Token, 'Correct');
      const found3FourthGameFirstPlayer = await findGameById(
        server,
        fourthGame.id,
        user1Token,
      );
    ...
    //   );
      ...
      const send4AnswerOnFourhtGameByFirstPlayer =
        await sendAnswersSecondPlayer(server, user1Token, 'Correct');
      const found4FourthGameFirstPlayer = await findGameById(
        server,
        fourthGame.id,
        user1Token,
      );
    ...
    //   );
      ...
      const send5AnswerOnFourhtGameByFirstPlayer =
        await sendAnswersSecondPlayer(server, user1Token, 'Correct');
      const found5FourthGameFirstPlayer = await findGameById(
        server,
        fourthGame.id,
        user1Token,
      );
    ...
    //   );
      ...
      const restulFourthGameFirstPlayer = await findGameById(
        server,
        fourthGame.id,
        user1Token,
      );
      expect(restulFourthGameFirstPlayer[1].status).toBe(
        GameStatusEnum.Finished,
      ); // todo скопируй енамку и
    });
    ...
    it('create fifth game (3 and 4 user)', async () => {
      ...
      const send1AnswerOnFifthGameByFourthPlayer = await sendAnswersFirstPlayer(
        server,
        user4Token,
        'Incorrect',
        fivethGame,
      );
      const found1FifthGameFourthPlayer = await findGameById(
        server,
        fivethGame.id,
        user4Token,
      );
    ...
    //   );
      ...
      const found2FifthGameFourthPlayer = await findGameById(
        server,
        fivethGame.id,
        user4Token,
      );
    ...
    //   );
      ...
      const found3FifthGameFourthPlayer = await findGameById(
        server,
        fivethGame.id,
        user4Token,
      );
    ...
    //   );
      ...
      const found4FifthGameFourthPlayer = await findGameById(
        server,
        fivethGame.id,
        user4Token,
      );
      //   console.log(
      //     'found4FifthGameFourthPlayer: ',
      //     found4FifthGameFourthPlayer[1].secondPlayerProgress.score,
      //   );
      ...
      //   );
      //   console.log(
      //     'found5SecondGameThirdPlayer: ',
      //     found5SecondGameThirdPlayer[1].secondPlayerProgress.score,
      //   );
      ...
      const send1AnswerOnFifthGameByThirdPlayer = await sendAnswersSecondPlayer(
        server,
        user3Token,
        'Correct',
      );
      const found1FifthGameThirdPlayer = await findGameById(
        server,
        fivethGame.id,
        user3Token,
      );
    ...
    //   );
      ...
      const found2FifthGameThirdPlayer = await findGameById(
        server,
        fivethGame.id,
        user3Token,
      );
    ...
    //   );
      ...
      const found3FifthGameThirdPlayer = await findGameById(
        server,
        fivethGame.id,
        user3Token,
      );
    ...
    //   );
      ...
      const found4FifthGameThirdPlayer = await findGameById(
        server,
        fivethGame.id,
        user3Token,
      );
    ...
    //   );
      ...
      const found5FifthGameThirdPlayer = await findGameById(
        server,
        fivethGame.id,
        user3Token,
      );
    ...
    //   );
      ...
      const send5AnswerOnFifthGameByFourthPlayer = await sendAnswersFirstPlayer(
        server,
        user4Token,
        'Incorrect',
        fivethGame,
      );
      const found5FifthGameFourthPlayer = await findGameById(
        server,
        fivethGame.id,
        user4Token,
      );
    ...
    //   );
      ...
      //   expect(found5FifthGameFourthPlayer[1]).toEqual(
      //     found5FifthGameThirdPlayer[1],
      //   );

      expect(found5FifthGameFourthPlayer[1].secondPlayerProgress.score).toBe(0);

      const resultFifthGameThirdPlayer = await findGameById(
        server,
        fivethGame.id,
        user3Token,
      );
      //   console.log(
      //     'fourthPalyer: ',
      //     resultFifthGameThirdPlayer[1].firstPlayerProgress.score,
      //   );
      expect(resultFifthGameThirdPlayer[1].firstPlayerProgress.score).toBe(6);
      expect(resultFifthGameThirdPlayer[1].secondPlayerProgress.score).toBe(0);

      expect(resultFifthGameThirdPlayer[0]).toBe(200); // todo скопируй енамку и вставь вместо финиш
      expect(resultFifthGameThirdPlayer[1].status).toBe(
        GameStatusEnum.Finished,
      ); // todo скопируй енамку и
    });
    ...
    it.skip('create sixth game (1 and 2 user)', async () => {
      ...
      const send1AnswerOnSixthGameByFirstPlayer = await sendAnswersSecondPlayer(
        server,
        user1Token,
        'Correct',
      );
      const found1SixthGameFirstPlayer = await findGameById(
        server,
        sixthGame.id,
        user1Token,
      );
      ...
      const send2AnswerOnSixthGameByFirstPlayer = await sendAnswersSecondPlayer(
        server,
        user1Token,
        'Correct',
      );
      const found2SixthGameFirstPlayer = await findGameById(
        server,
        sixthGame.id,
        user1Token,
      );
      ...
      const send3AnswerOnSixthGameByFirstPlayer = await sendAnswersSecondPlayer(
        server,
        user1Token,
        'Correct',
      );
      const found3SixthGameFirstPlayer = await findGameById(
        server,
        sixthGame.id,
        user1Token,
      );
      ...
      const send4AnswerOnSixthGameByFirstPlayer = await sendAnswersSecondPlayer(
        server,
        user1Token,
        'Correct',
      );
      const found4SixthGameFirstPlayer = await findGameById(
        server,
        sixthGame.id,
        user1Token,
      );
      ...
      const send5AnswerOnSixthGameByFirstPlayer = await sendAnswersSecondPlayer(
        server,
        user1Token,
        'Correct',
        // sixthGame,
      );
      const found5SixthGameFirstPlayer = await findGameById(
        server,
        sixthGame.id,
        user2Token,
      );
      ...
      const send1AnswerOnSixthGameBySecondPlayer = await sendAnswersFirstPlayer(
        server,
        user2Token,
        'Incorrect',
        sixthGame,
      );
      const found1SixthGameSecondPlayer = await findGameById(
        server,
        sixthGame.id,
        user2Token,
      );
      ...
      const send2AnswerOnSixthGameBySecondPlayer = await sendAnswersFirstPlayer(
        server,
        user2Token,
        'Incorrect',
        sixthGame,
      );
      const found2SixthGameSecondPlayer = await findGameById(
        server,
        sixthGame.id,
        user2Token,
      );
      ...
      const send3AnswerOnSixthGameBySecondPlayer = await sendAnswersFirstPlayer(
        server,
        user2Token,
        'Incorrect',
        sixthGame,
      );
      const found3SixthGameSecondPlayer = await findGameById(
        server,
        sixthGame.id,
        user2Token,
      );
      ...
      const send4AnswerOnSixthGameBySecondPlayer = await sendAnswersFirstPlayer(
        server,
        user2Token,
        'Incorrect',
        sixthGame,
      );
      const found4SixthGameSecondPlayer = await findGameById(
        server,
        sixthGame.id,
        user2Token,
      );
      ...
      const send5AnswerOnSixthGameBySecondPlayer = await sendAnswersFirstPlayer(
        server,
        user2Token,
        'Incorrect',
        sixthGame,
      );
      const found5SixthGameSecondPlayer = await findGameById(
        server,
        sixthGame.id,
        user2Token,
      );
    ...
    it.skip('get user top', async () => {
      // console.log('try:')
      const getUserTop = await request(server).get(`/pair-game-quiz/users/top`);

...
import { createAddUser, createBlogBlogger, createCom, createPostBlogger, createToken } from '../../../src/helpers/helpers';
...
describe('/blogs', () => {
	...
	describe('some description', () => {
		...
		it('get ban user', async() => {
			const result = await getAllBanUsers(server, createBlog.id, user2Token)
		})
	})
})